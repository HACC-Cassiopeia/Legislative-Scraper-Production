...
export const writerProfilePublications = {
...
class WriterProfileCollection extends BaseProfileCollection {
  ...
  publish() {
    if (Meteor.isServer) {
      ...
      Meteor.publish(writerProfilePublications, function publish() {
   ...
   */
  subscribeWriterProfile() {
    if (Meteor.isClient) {
      return Meteor.subscribe(writerProfilePublications.writerProfile);
    }
    return null;
  }

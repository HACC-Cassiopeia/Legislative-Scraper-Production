...
import { SubmitterProfiles } from './SubmitterProfileCollection';

/* eslint prefer-arrow-callback: "off",  no-unused-expressions: "off" */
/* eslint-env mocha */

if (Meteor.isClient) {
  describe('SecSubmitterProfileCollection Meteor Methods', function testSuite() {
    it('Can define, update, and removeIt', async function test1() {
      ...
      const collectionName = SubmitterProfiles.getCollectionName();
      ...
      expect(SubmitterProfiles.isDefined(docID)).to.be.true;
      let doc = SubmitterProfiles.findDoc(docID);
      ...
      doc = SubmitterProfiles.findDoc(docID);
      ...
      expect(SubmitterProfiles.isDefined(docID)).to.be.false;
    });
  });
}
